...
func TestInvalidVarint(t *testing.T) {
	testCases := []struct {
		...
		// https://aresgo/router/google/snappy/blob/master/format_description.txt
...
func TestSameEncodingAsCppLongFiles(t *testing.T) {
	...
	if failed {
		t.Errorf("was the snappytool program built against the C++ snappy library version " +
			...
			"https://aresgo/router/google/snappy/commit/d53de18799418e113e44444252a39b12a0e4e0cc")
	}
}
...
func TestReaderUncompressedDataTooLong(t *testing.T) {
	// https://aresgo/router/google/snappy/blob/master/framing_format.txt section
